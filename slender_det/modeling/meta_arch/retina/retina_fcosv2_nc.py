...
class FCOSNCRetinaNet(RetinaNet):
    ...
    def __init__(self, cfg):
        ...
        self.head = FCOSNCRetinaNetHead(cfg, feature_shapes)
    ...
    def forward(self, batched_inputs):
        ...
        box_cls, box_reg = self.head(features)
        ...
        if self.training:
            ...
            losses = self.losses(gt_classes, reg_targets, box_cls, box_reg)

            return losses
        else:
            results = self.inference(locations, box_cls, box_reg, images.image_sizes)
    ...
    def inference(self, locations, box_cls, box_reg, image_sizes):
        ...
        for img_idx, image_size in enumerate(image_sizes):
            ...
            results_per_image = self.inference_single_image(
                locations, box_cls_per_image, box_reg_per_image, tuple(image_size)
            )
...
class FCOSNCRetinaNetHead(nn.Module):
    ...
    def __init__(self, cfg, input_shape: List[ShapeSpec]):
        ...
        """
        super(FCOSNCRetinaNetHead, self).__init__()
