...
from detectron2.data.datasets import load_coco_json as d2_coco_json, register_coco_instances
...
def register_obj365_coco_type(name, metadata, json_file, image_root):
    ...
    assert isinstance(image_root, (str, os.PathLike)), image_root
    # 1. register a function which returns dicts
    DatasetCatalog.register(name, lambda: d2_coco_json(json_file, image_root, name))
